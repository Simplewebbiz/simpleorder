        ...
        <div v-else class="checkout__grid">
            <div class="checkout__form">
                ...
                <div class="method-toggle">
                    <button :class="{ active: payment.method === 'pickup' }" @click="payment.method = 'pickup'">Pickup</button>
                    <button :class="{ active: payment.method === 'delivery' }" @click="payment.method = 'delivery'" v-if="settings.allow_delivery">Delivery</button>
                </div>
            ...
            <div class="checkout__summary">
                ...
                <div class="checkout__totals">
                    ...
                    <div class="total-row tip-row">
                        <span>Tip</span>
                        <input v-model="payment.tip" type="number" step="0.01" min="0" placeholder="0.00" class="tip-input" />
                    </div>
...
const total = computed(() => Math.round((subtotal.value + tax.value + delivery.value + tip.value) * 100) / 100)
